/*
 * Vendorizado: docx-preview v0.4.0
 * Fuente: https://cdn.jsdelivr.net/npm/docx-preview@0.4.0/dist/docx-preview.min.js
 * Vendorizado el: 2026-08-14
 * Licencia: Apache-2.0 (ver cabecera original abajo)
 * NOTA DE SEGURIDAD: procesa archivos .docx subidos por usuarios -- revisar
 * changelog/CVEs antes de actualizar la version. Su salida se renderiza
 * dentro de un iframe sandboxed same-origin (ver files/static/files/js/filearchive_split.js),
 * nunca directo al DOM de la pagina, como defensa en profundidad.
 */
/*
 * @license
